...
//        log.info("분석할 문장 : " + text);
        if (text == null || text.isEmpty()) {
            throw new CustomException(ErrorCode.WORDANALYSIS_EMPTY_VALUE);
        }
...
//        log.info(this.getClass().getName() + ".doWordAnalysis End !");
    ...
    @Override
    public Map<String, Integer> doWordCount(List<String> pList) {
...
//        log.info(this.getClass().getName() + ".doWordCount End !");
    ...
    @Override
    public Map<String, Integer> doWordAnalysis(String text) {
        if (text == null || text.isEmpty()) {
            throw new CustomException(ErrorCode.WORDANALYSIS_EMPTY_VALUE);
        }
